...
rb_red_blk_tree* RBTreeCreate( 
               const char *key_name,   /* for prettyprint*/
               const char *info_name,  /* for prettyprint*/
               int (*CompFunc) (const void*,const void*),
			      void (*DestFunc) (void*),
			      void (*InfoDestFunc) (void*),
			      void (*PrintFunc) (const void*),
			      void (*PrintInfo)(void*),
               void* (*GetInfoFunc)(void*),
               void (*SetInfoFunc)(void*, void*)) {
  ...
  newTree->GetInfo = GetInfoFunc;
  newTree->SetInfo = SetInfoFunc;
  strncpy(newTree->key_name, key_name, MAX_NAME_LEN);
  strncpy(newTree->info_name, info_name, MAX_NAME_LEN);
